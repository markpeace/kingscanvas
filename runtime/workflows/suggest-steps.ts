...
export async function suggestStepsWorkflow(payload: SuggestStepsInput): Promise<WorkflowResult> {
  ...
  debug.trace("AI Prompt Builder v5: constructed prompt (runtime)", {
  ...
  debug.trace("AI: suggest-step using model (runtime)", {
    model: resolvedModel,
