...
export const mockIntentions: Intention[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: 'step-006',
        clientId: 'client-step-006',
        intentionId: 'int-002',
        title: 'Plan a course social',
        bucket: 'do-now',
        order: 3
      }
    ],
